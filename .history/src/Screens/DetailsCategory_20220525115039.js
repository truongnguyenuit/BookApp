...
const DetailsCategory = ({ route, navigation }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <View>
                <Text style={styles.}>Category: {categoryy}</Text>
            </View>
            ...
            <View style={styles.imgcontainer}>
                ...
                {/* <TouchableOpacity
                    ...
                    onPress={() => {
                        //array1.push({id : 9, value : "supro"})
                        //let newArr = [...array1]
                        //setarray(newArr)
                        
                        setarray([...array, { id: 45, value: "Truong" }])
                        //setarray(oldArray => [...oldArray,{ id: 45, value: "Truong" }])
                    }}
                >
                    <Text>   BUTTONNNNN   </Text>
                </TouchableOpacity> */}
            </View>
        </View>
    )
