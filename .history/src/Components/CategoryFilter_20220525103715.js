...
export default function BookOverview({ navigation, book, booksarray, setbook }) {
    ...
    return (
        <View>
            ...
            {arr.map((book) => (
                <TouchableOpacity TouchableOpacity style={styles.main_view} onPress={() => navigation.navigate('BookDetails', { Img: Img, Name: Name, Author: Author, Description: Description, Content: Content })}>
