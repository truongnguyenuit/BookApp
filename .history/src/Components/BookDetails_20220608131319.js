...
export default function BookDetails({ route, navigation }) {
  ...
  const ReadCommentFromDB = async () => {
    ...
    querySnapshot.forEach((doc) => {
      ...
      setarr(oldArray => [...oldArray, { cccontent: content, nnname: name, uuusername: userName }])
    });
  }
      ...
      <ScrollView>
        ...
        <View style={styles.cardcontainer}>
          ...
          <TouchableOpacity
            ...
            onPress={handleComment, ReadCommentFromDB}
          >
          ...
          {arr.map((comment, key) => (
            ...
            >
              <View style={styles.readerContainer}>
                ...
                <Text style={styles.readerUser}>{comment.uuusername}</Text>
              </View>

              <Text>{comment.cccontent}</Text>
            </View>
          ))}
        </View>
