...
export default function BookOverview({ navigation, book, bookarray, setbook }) {
    const array1 = [
    ...
    const ReadBookFromDB = async () => {
        ...
        querySnapshot.forEach((doc) => {
            ...
            setcontent(content)
            //setarray(oldArray => [...oldArray, { Img: img, Name: name, Author: author, Description: description, Content: content }])
        });
    }
