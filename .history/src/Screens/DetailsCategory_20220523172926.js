...
const DetailsCategory = ({ route, navigation }) => {
    ...
    //const array2 = array1.push({ id : 4, value: "newyork"})
    const [array,setarray] = useState(array2)
    //array1= array1.push({ id : 4, value: "newyork"});
    ...
    return (
        <View style={styles.container}>
           ...
           // onPress={array1.push({ id : 4, value: "newyork"})}
