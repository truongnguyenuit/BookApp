  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView>
        <TouchableOpacity 
        style={styles.card}
        onPress={()=> navigation.navigate("DetailsCategory",{categoryy:"funny", navigation: navigation})}
        >
        ...
        <TouchableOpacity 
        style={styles.card}
        onPress={()=> navigation.navigate("DetailsCategory",{category: "drama", navigation: navigation})}>
          <View style={styles.cardImgWrapper}>
            <Image
