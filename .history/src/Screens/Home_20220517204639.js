    ...
    <View style={styles.mainview}>
      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.categoryContainer}>
          ...
          <TouchableOpacity style={styles.categoryBtn} onPress={HandleReadDB}>
        ...
        <Text style={{ fontSize: 28, fontWeight: "bold", alignSelf: 'center', marginBottom: 20, color: 'black', marginTop: 10 }}>Recently Viewed</Text>
        <View style={styles.shelf}>
          <BookOverview book={BooksList.firstbook} navigation={this.props.navigation}/>
          <BookOverview book={BooksList.secondbook} navigation={this.props.navigation}/>
        </View>
