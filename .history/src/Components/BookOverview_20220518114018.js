...
export default function BookOverview( { navigation, book } ) {
  ...
  return (
    <TouchableOpacity style= {styles.main_view} onPress={() => navigation.navigate('BookDetails', { Img: 85, Name:name, Author: author, Description: description, Content: content})}>
